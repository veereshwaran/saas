...
resource "cassandra",
  :cookbook => "appranix-saas.1.cassandra",
  :design => true,
  :requires => {
      :constraint => "1..1",
      :services => "mirror",
...
'clouds' => {
    ...
    'definition' => '{
       ...
       "direction": "to",
       "targetClassName": "manifest.appranix-saas.1.Cassandra",
       "relations": [
         { "returnObject": false,
           "returnRelation": false,
            ...
            "flow": [
                {
                    ...
                    "execStrategy": "one-by-one",
                    "direction": "from",
                    "targetClassName": "bom.appranix-saas.1.Cassandra",
                    "actions": [
                        {
                            "actionName": "nodetool",
                            "stepNumber": 1,
