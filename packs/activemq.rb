...
resource 'activemq',
    :cookbook => "appranix-saas.1.activemq",
    :design => true,
    :requires => {
      :constraint => "1..1",
      :services => "mirror",
...
resource "keystore",
         :cookbook => "core.1.keystore",
         :design => true,
         :requires => {"constraint" => "0..1"},
         :attributes => {
             "keystore_filename" => "$AX_LOCAL{keystorepath}"
  }

resource "queue",
  :cookbook => "core.1.queue",
  :design => true,
  :requires => {
      :constraint => "0..*",
      :help => 'Queues'
    ...
    :payloads => {
           'activemq' => {
             ...
             :definition  => '{
                ...
                "direction": "from",
                "targetClassName": "bom.appranix-saas.1.Activemq"
              }'
           }
         } ,
   :monitors => {
