name 'Activemq'
maintainer 'Prana'
maintainer_email    "support@prana.com"
...
attribute 'operationssupport',
          ...
          :default => 'false',
          :format => {
              :help => 'Enable in admin console operations such as creating, deleting, or purging messages from destination. It is recommended to keep this feature disabled as those operations should be through Prana; Enabling it will result in Prana deployment out of synch with ActiveMQ.',
              :category => '2.Administration',
              :form => {'field' => 'checkbox'},
              :order => 8
          }
...
attribute 'restapisupport',
          ...
          :default => 'false',
          :format => {
              :help => 'Enable admin REST api allows operations such as destination creation or deletion via Jolokia REST call. It is recommended to keep this feature disabled as actions via REST API will bypass Prana, resulting in Prana deployment out of synch with ActiveMQ.',
              :category => '2.Administration',
              :form => {'field' => 'checkbox'},
              :order => 9
          }
